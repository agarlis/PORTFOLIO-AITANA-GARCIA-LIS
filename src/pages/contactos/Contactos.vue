...
<template>
    ...
    <section class="min-h-screen px-8 md:px-20 py-45">
            ...
            <Card class="border-none shadow-none">
                <CardContent class="space-y-8 p-0">
                    ...
                    <!-- Nombre -->
                        ...
                        <!-- Tipo proyecto -->
                        <div class="respuesta space-y-4">
                            <Label class="etiqueta">Tipo de proyecto</Label>
                            <Select v-model="form.projectType">
                                <SelectTrigger>
                                <SelectValue placeholder="Selecciona una opción" class="etiqueta" />
                                </SelectTrigger>
                                <SelectContent>
                        ...
                        <div class="respuesta space-y-4">
                            <Label class="etiqueta">Reunión</Label>
                            <Popover>
                        ...
                        <div class="flex items-center space-x-2">
                            <Checkbox id="privacy" v-model:checked="form.privacy" />
                            <Label for="privacy" class="etiqueta text-sm text-muted-foreground">
                            Acepto la política de privacidad
                            </Label>
                        </div>
                        <!-- Botón -->
                        <Button type="submit" class="etiqueta w-full mt-4">
                            Enviar mensaje
                        </Button>
                    </form>
                </CardContent>
